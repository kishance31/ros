...
const GreenButton = (props) => {
    ...
    return (
        <>
            <button className="modal-fill_btn btn btn-lg" data-toggle="modal" data-target="#" data-dismiss="modal">
                {props.Children}
                <span class="sign_in">
                    {buttonName}
                </span>
                <span class="left_arrow"><svg xmlns="http://www.w3.org/2000/svg" width="18.63" height="13.08" viewBox="0 0 18.63 13.08">
